  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full border-b border-outline-variant bg-surface-container-low text-primary md:hidden">
        <div className="flex h-16 w-full items-center justify-between px-margin-edge">
          <BrandMark />
          <ProfileAvatar />
        </div>
      </header>
      <header className="sticky top-0 z-40 hidden min-h-16 w-full flex-wrap items-center justify-between gap-x-4 gap-y-3 border-b border-outline-variant bg-surface-container-low px-margin-edge py-3 text-primary shadow-sm md:flex md:flex-nowrap md:py-0">
        <div className="min-w-0 shrink-0">
          <BrandMark />
        </div>
        <nav className="flex min-w-0 flex-1 flex-wrap justify-center gap-x-4 gap-y-1 md:justify-center">
